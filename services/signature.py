...
RULES = [
    ...
    # ===================== قواعد أحمد (2026-08-10) =====================
    {
        "id": "threshold_level_diff",
        "layer": FIXED,
        "category": "الأرضيات",
        "status": CONFIRMED,
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "فرق منسوب ٢ سم على الأقل عند عتبة تغيير الأرضية",
        "why": "من غيره العتبة بتتكسر وبتفضل تتعثر فيها، والتفاوت الطبيعي بين الخامتين بيبان.",
        "applies_at": "execution",
    },
    {
        "id": "appliance_door_clearance",
        "layer": FIXED,
        "category": "المطبخ",
        "status": CONFIRMED,
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "٧٦ سم مسافة أمان قدام أي جهاز بابه بيفتح",
        "why": "الباب اللي مبيفتحش كامل بيخلي الجهاز نص جهاز، وبيتكتشف بعد التركيب.",
        "applies_at": "layout",
    },
    {
        "id": "no_split_facing_bed",
        "layer": FIXED,
        "category": "الفراغ",
        "status": CONFIRMED,
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "مفيش سبلت مواجه سرير أو كنبة مباشرة",
        "why": "الهوا المباشر على النايم أو القاعد بيمرّض، والعميل بيقفل التكييف ويشتكي من الحر.",
        "applies_at": "layout",
    },
    {
        "id": "accent_echo",
        ...
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "لون اللمسة يتكرر في حاجة صغيرة تانية بعيدة عن مكانه الأساسي",
        "why": "اللمسة اللي في مكان واحد بتقرا غلطة، واللي بتترد بتقرا قرار.",
    ...
    },
    {
        ...
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "الفراغ المفتوح له نقطة ارتكاز بصرية واحدة تُرى من كل زاوية",
        "why": "من غيرها العين متلاقيش مكان تستقر فيه، والفراغ بيقرا مبعثر مهما كانت الخامات حلوة.",
        "applies_at": "layout",
    },
    {
        "id": "one_colour_temperature",
        "layer": METHOD,
        "category": "النور",
        "status": CONFIRMED,
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "درجة حرارة اللون واحدة في الوحدة كلها",
        "why": ("الاتساق نفسه هو القاعدة -- بيشتغل مع أي درجة. الرقم اللي بتختاره "
                "ذوق، لكن اختلافه بين أوضة وأوضة غلط."),
        "applies_at": "lighting",
    },
    {
        "id": "reflective_in_small_areas",
        "layer": METHOD,
        "category": "الخامات",
        "status": CONFIRMED,
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "الخامة العاكسة مساحات صغيرة أو متوسطة — مش أرضية كاملة تحت إضاءة سقفية",
        "why": "الأرضية العاكسة تحت السبوت بتبقى مرايا للوحدات وبتوهج العين طول اليوم.",
        "applies_at": "materials",
    },
    {
        "id": "broken_rule_on_record",
        "layer": METHOD,
        "category": "الممارسة",
        "status": CONFIRMED,
        "origin": AHMED,
        "captured": "2026-08-10",
        "text": "أي قاعدة اتكسرت بطلب العميل تتسجل في محضر التسليم: مين اقترح ومين وافق",
        "why": ("أحمد حطها تحت الاقتراح، وهي هنا في الطريقة لأنها **مبتتنازلش**: "
                "قاعدة التسجيل اللي ينفع يتنازل عنها مالهاش لازمة. ودي اللي بتحمي "
                "من 'انت اللي اخترت' بعد سنة."),
        "applies_at": "execution",
    },
    {
        "id": "palette_60_30_10",
    ...
    },
    {
        ...
        "origin": SEEDED,
        "captured": "2026-08-10",
        "text": "الأبيض الصافي ممنوع على الحوائط — يتكسر ببيج أو رمادي دافي",
        "why": ("الأبيض الخالص مفيهوش صبغة تمسك النور، فبيروح رمادي في الظل وأزرق "
                "تحت نور النهار، وبيخلي أي حاجة جنبه تبان متسخة."),
        "applies_at": "materials",
    },
    {
        "id": "no_cold_under_egyptian_sun",
        "layer": METHOD,
        "category": "البالتة",
        "status": CONFIRMED,
        "origin": SEEDED,
        "captured": "2026-08-10",
        "text": "مفيش رمادي بارد كمساحة كبيرة تحت شمس مصر",
        "why": ("نور القاهرة أصفر وقوي، والبارد تحته بيقرا متسخ مش هادي. المشكلة مش "
                "في اللون، المشكلة إنه اتشاف تحت نور تاني."),
        "applies_at": "materials",
    },
    {
        "id": "one_strong_accent",
        "layer": METHOD,
        "category": "البالتة",
        "status": CONFIRMED,
        "origin": SEEDED,
        "captured": "2026-08-10",
        "text": "لمسة قوية واحدة في الفراغ — مش اتنين",
        "why": "اللمستين بيتخانقوا فمحدش بيكسب، والفراغ بيقرا مشتت مش غني.",
        "applies_at": "materials",
    },
    {
        "id": "colour_needs_a_source",
        "layer": METHOD,
        "category": "البالتة",
        "status": CONFIRMED,
        "origin": SEEDED,
        "captured": "2026-08-10",
        "text": "كل لون في الفراغ له مصدر — خامة، منظر، أو حاجة العميل بيحبها",
        "why": ("اللون اللي اتاخد من صورة ومالوش أصل في المكان بيقرا ملزوق مش نابع، "
                "ومحدش بيعرف يقول ليه بس الكل بيحس."),
        "applies_at": "materials",
    },
    {
        "id": "main_corridor_90",
    ...
    # ===================== النور =====================
    {
        ...
        "origin": SEEDED,
        "captured": "2026-08-09",
        "text": "٣٠٠٠ كلفن تحديدًا",
        "why": ("الرقم نفسه ذوق -- الاتساق قاعدة منفصلة في الطريقة "
                "(one_colour_temperature). ٣٠٠٠ بيدي دفا من غير ما يصفّر الأبيض."),
        "applies_at": "lighting",
    },
    {
