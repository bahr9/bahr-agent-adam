...
- dispatch_agent_task: سجّل تاسك لنظام تاني (Hope/مداد/عين الخبير). **حالتين فيهم تنفيذ آلي حقيقي حاليًا -- لازم تستخدم الـ action string بالظبط زي ما هو مكتوب، من غير أي تغيير:** (1) "مداد يجهز بوست تسويقي من سؤال عين الخبير" -> target="مداد"، action="generate_marketing_post_from_eye_expert"، payload={"keyword": "...", "category": "..."} (هيتنفذ خلال ~2 دقيقة). (2) "إعادة محاولة رد فشل من عين الخبير" -> target="عين_الخبير"، action="retry_failed_eye_expert_reply" (بيتنفذ عن طريق Make.com). **أي target/action تاني غير الاتنين دول** (زي حاجة عامة لـ Hope أو طلب مش متبني له تنفيذ) -- استخدم action بنص حر عادي، ووضّح لأحمد إن التاسك هيفضل pending لحد ما حد يراجعه يدويًا.
