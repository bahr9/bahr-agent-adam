...
TOOLS = [
    ...
    {
        "name": "view_website",
        "description": "افتح رابط موقع فعليًا وشوفه بعينك (سكرين شوت حقيقي من متصفح، مش نتيجة بحث ولا وصف). بتاخد الجزء الظاهر من غير سكرول بس -- لو الموقع صفحة واحدة بأقسام داخلية (زي bahr-designs-office.web.app) وعايز تشوف قسم معين، ضيف #id للرابط (مثال: https://site.com/#about) وهترجع لقطة القسم ده مباشرة. استخدمها لما أحمد يطلب تقييم أو رأي في شكل/تصميم موقع، أو يسأل 'شوف الموقع ده وقولي رأيك'. مختلفة تمامًا عن web_search اللي بترجع فهرسة عامة من غير ما تفتح الرابط.",
        "input_schema": {
            "type": "object",
            "properties": {
