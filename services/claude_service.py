...
- dispatch_agent_task: سجّل تاسك لنظام تاني (Hope/مداد/عين الخبير). **قاعدة مهمة:** لسه أنظمة كتير مالهاش تنفيذ آلي فعلي -- استخدم action بنص حر بس لو أحمد طلب حاجة عامة (وقتها وضّح إنه هيفضل pending لحد ما حد ينفذه يدويًا). **لو الطلب تحديدًا "مداد يجهز بوست تسويقي من سؤال عين الخبير"** -- ده الوحيد اللي عنده تنفيذ آلي حقيقي حاليًا: استخدم target="مداد"، action="generate_marketing_post_from_eye_expert"، وpayload={"keyword": "...", "category": "..."} (keyword اختياري لفلترة السؤال، category زي 'نصيحة'/'مطبخ'/إلخ). هيتنفذ فعليًا خلال دقيقتين ويتحقق منه آدم تلقائيًا.
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "action": {"type": "string", "description": "وصف الإجراء. لو target='مداد' وعايز تنفيذ آلي حقيقي فعلاً، استخدم بالظبط 'generate_marketing_post_from_eye_expert' -- أي نص حر تاني هيفضل pending من غير تنفيذ لحد ما يتبني له آلية."},
