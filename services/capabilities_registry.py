...
_TOOL_METADATA = {
    ...
    "get_bahr_projects":            {"domain": "projects", "operation_type": "read", "criticality": "low",
                                     ...
                                     "source_owner": "services/supabase_store.py (فولباك Firestore)"},
    ...
    "update_project_status":       {"domain": "projects", "operation_type": "write", "criticality": "medium",
                                     "source_owner": "services/supabase_store.py (أعمدة آدم بس)"},
